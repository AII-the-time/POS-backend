...
const api: FastifyPluginAsync = async (server: FastifyInstance) => {
    ...
    server.get<Stock.getMixedStockInterface>(
        ...
        async (request, reply) => {
            const result = await stockService.getMixedStock(request.body, request.params);
            reply
                .code(200)
                .send(result);
        }
    ...
    server.get<Stock.searchStockInterface>(
        ...
        async (request, reply) => {
            const result = await stockService.searchStock(request.body, request.query);
            reply
                .code(200)
                .send(result);
        }
    ...
    server.get<Stock.searchStockAndMixedStockInterface>(
        ...
        async (request, reply) => {
            const result = await stockService.searchStockAndMixedStock(request.body, request.query);
            reply
                .code(200)
                .send(result);
        }
