...
export type SchemaToInterfase<T extends {body?:JSONSchema, querystring?:JSONSchema, params?:JSONSchema, headers?:JSONSchema,response: {[key:string]:JSONSchema}}>={
    ...
    Reply: {
        [key in keyof T['response']]: FromSchema<T['response'][key],{ deserialize: [{pattern: {type: 'string'; format: "date-time"}; output:Date }] }>;
    }
}
